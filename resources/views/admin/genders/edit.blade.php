...
<div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      ...
      <div class="w3-twothird">
        <h5>Table for updates genders</h5>
        <div class="form-group">
        	<form method="post" action="{{ url('genders/update/'.$gender->id) }}">
        		@csrf
    		<label for="gender_name">Gender name:</label>
    		<input type="text" class="form-control" placeholder="Enter gender" id="gender" name="gender_name" value="{{ $gender->gender_name }}">
